  ...
  return (
    <>
      <div className="h-[calc(72vh)] md:h-[calc(85vh)] flex flex-col items-center mt-4">
        <h1 className="text-center text-4xl py-6 font-bold text-custom-ivory">
            ...
            >
              <div className="mr-2 p-2 bg-custom-ivory flex flex-col items-center rounded-md">
                <img
                  src={yoga}
                  alt="yoga"
                  className="w-full h-64 md:h-72 rounded-t-md shadow-lg"
                />
                <h2 className="py-1 text-xl md:text-2xl font-semibold">
                  {t("carousal.card1.title", "Yoga")}
                </h2>
                <p className="py-2">
                  {t(
                    "carousal.card1.desc",
                ...
                <Link
                  to="yoga"
                  className="px-3 py-2 bg-custom-maroon text-custom-ivory rounded-lg my-3 active:scale-95"
                >
                  {t("carousal.button", "View Details")}
                </Link>
              </div>
              <div className="mr-2 p-2 bg-custom-ivory flex flex-col items-center rounded-md">
                <img
                ...
                />
                <h2 className="py-1 text-xl md:text-2xl font-semibold">
                  {t("carousal.card2.title", "Shraddha (Ancestral Rites )")}
                </h2>
                <p className="py-2">
                  {t(
                    "carousal.card2.desc",
              ...
              <div className="mr-2 p-2 bg-custom-ivory flex flex-col items-center rounded-md">
                ...
                />
                <h2 className="py-1 text-xl md:text-2xl font-semibold">
                  {t("carousal.card3.title", "Vedic Pooja")}
                </h2>
                <p className="py-2">
                  {t(
                    "carousal.card3.desc",
              ...
              <div className="mr-2 p-2 bg-custom-ivory flex flex-col items-center rounded-md">
                ...
                />
                <h2 className="py-1 text-xl md:text-2xl font-semibold">
                  {t("carousal.card4.title", "Vastu-Shastra")}
                </h2>
                <p className="py-2">
                  {t(
                    "carousal.card4.desc",
              ...
              <div className="mr-2 p-2 bg-custom-ivory flex flex-col items-center rounded-md">
                ...
                />
                <h2 className="py-1 text-xl md:text-2xl font-semibold">
                  {t("carousal.card5.title", "Astrology")}
                </h2>
                <p className="py-2">
                  {t(
                    "carousal.card5.desc",
              ...
              <div className="mr-2 p-2 bg-custom-ivory flex flex-col items-center rounded-md">
                ...
                />
                <h2 className="py-1 text-xl md:text-2xl font-semibold">
                  {t("carousal.card6.title", "Disease Consultancy")}
                </h2>
                <p className="py-2">
                  {t(
                    "carousal.card6.desc",
